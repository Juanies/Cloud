    ...
    if (props.type == "password") {
        return (
            <div className='input-container'>
                <input id='input' onBlur={addBlur} onFocus={addFocus} className="password" name={props.name} type={type} />
        ...
        return (
            <div className='input-container'>
                <input onBlur={addBlur} onFocus={addFocus}   className='' name={props.name} type={type} />
                <label  htmlFor={props.name} >{props.text}</label>
            </div>
        );
    }
